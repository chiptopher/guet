...
from guet.commands.decorators.start_required_decorator import StartRequiredDecorator, NOT_RAN_IN_ROOT_DIRECTORY_ERROR
from guet.settings.settings import Settings


@patch('guet.commands.decorators.start_required_decorator.project_root', return_value='.')
@patch('guet.commands.decorators.start_required_decorator.Git')
