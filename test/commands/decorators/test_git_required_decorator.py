...
@patch('guet.commands.decorators.git_required_decorator.Git')
@patch('guet.commands.decorators.git_required_decorator.getcwd', return_value='/absolute/path/to/cwd')
